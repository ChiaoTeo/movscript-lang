...
export const MOVSCRIPT_DOMAIN_WORKSPACE_MODELS: Record<MovScriptDomainWorkspaceKind, MovScriptDomainWorkspaceModel> = {
  ...
  asset_workspace: {
    ...
    editablePathPatterns: [
      'settings/{settingSlug}/assets/{assetSlug}/asset.json',
      'settings/{settingSlug}/states/{settingStateSlug}/assets/{assetSlug}/asset.json',
    ],
    contextPathPatterns: ['settings/{settingSlug}/setting.json', 'project_standards.json'],
    schemaIds: ['movscript.asset.v1'],
    instructions: ['Assets are setting-owned resource slots. Runtime candidates and production decisions are stored outside asset.json.'],
  },
  script_workspace: {
    kind: 'script_workspace',
  ...
  writing_expression_workspace: {
    ...
    editablePathPatterns: ['productions/{productionSlug}/segments/{segmentSlug}/scene_moments/{sceneMomentSlug}/storyboards/{storyboardSlug}/writing_expressions/{writingExpressionSlug}/writing_expression.json'],
    contextPathPatterns: ['productions/{productionSlug}/segments/{segmentSlug}/scene_moments/{sceneMomentSlug}/storyboards/{storyboardSlug}/storyboard.json'],
